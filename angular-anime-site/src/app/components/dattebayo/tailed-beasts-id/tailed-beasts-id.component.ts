import { ICharacter, ICharacterTable } from '@/src/app/models/dattebayo';
...
@Component({
  selector: 'app-tailed-beasts-id',
  imports: [LoadingComponent, CommonModule, RouterModule],
  templateUrl: './tailed-beasts-id.component.html',
  styleUrl: './tailed-beasts-id.component.css',
})
export class TailedBeastsIdComponent {
  constructor(
